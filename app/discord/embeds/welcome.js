...
module.exports = comp =>
  comp
    ...
    .addField(
      'Command Prefixes',
      'You are able to change the prefix for all commands by using `!prefix <new prefix>`. Note that the prefix cannot have a # or @ symbol.',
      true,
    )
    .addField('\u200b', '\u200b')
    ...
    .addField(
      'Moderation Commands',
      'There are a few moderation commands, most of them being for users in voice chat. Use `!help moderation` to see all these commands.',
      true,
    )
    .addField(
      'Rooms',
      'This bot supports rooms (up to 25 per server!) in order to help organize members of your server when playing games, creating meetings, etc... ' +
        'The rooms support a variety of features, use `!help room` to see details on how to use them.',
    )
    .addField(
      'Feature Requests',
      'This bot is actively being developed and intends to be a fully featured bot. ' +
    ...
    .addField(
      ...
      'If you like this bot and want to help make it more robust, donations would be greatly appreciated. ' +
        ...
        'Donators will get priority feature requests **and** can request highly specialized commands such as win trackers, etc...',
    );

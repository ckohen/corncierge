        ...
        switch (method) {
            ...
            case 'set':
                ...
                if (Number(extraArgs[0])) {
                    ...
                    room = rooms.find(room => room.owner == String(message.member.id));
                    if ((typeof room == 'undefined' || rooms == null)) {
                        room = false;
            ...
            case "remove":
                ...
                if (typeof room == 'undefined' || rooms == null) {
                    ...
                    room = extraArgs[0] ? false : rooms.find(room => room.owner == String(message.member.id));
            ...
            case "transfer":
                ...
                if (typeof room == 'undefined' || rooms == null) {
                    ...
                    room = extraArgs[1] ? false : rooms.find(room => room.owner == String(message.member.id));

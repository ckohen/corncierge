    ...
    if (args[0] == "legacy") {
      ...
      switch (request) {
        ...
        case "moderation":
          ...
          msg.addField("Auto role assignment", "`" + commandPrefix + "autorole <@role> [delay]` **->** sets a role to automatically be added with optional delay (in seconds, or add 'm' to specify minutes, e.g. 10m for 10 minutes, maximum 20 minutes).\n`" + commandPrefix + "autorole remove` **->** removes the automatic role adding setting.\n`" + commandPrefix + "autorole [status]` **->** displays the current autorole and delay.");
